    ...
    <section className="py-20 relative">
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Poslední aktualizace: 10. února 2026 &bull; Verze 2.0
        </p>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-6">
            ...
            <div className="text-slate-400 leading-relaxed space-y-3">
              ...
              <p>
                ...
                (aktuální cena uvedena na stránce Ceník). Monitoring
                je samostatná služba nad rámec jednorázových balíčků.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-6">
            ...
            <div className="text-slate-400 leading-relaxed space-y-3">
              <p>
                14.1. Tyto VOP se řídí právním řádem České republiky, zejména
                zákonem č. 89/2012 Sb. (občanský zákoník) a zákonem
                č. 634/1992 Sb. (zákon o ochraně spotřebitele).
              </p>
              <p>
                14.2. Případné spory budou řešeny příslušným soudem v České
                republice.
              </p>
              <p>
                14.3. Spotřebitel může využít mimosoudní řešení sporu
                prostřednictvím{" "}
                <a
              ...
              <p>
                14.4. Poskytovatel si vyhrazuje právo tyto VOP změnit.
              ...
              <p>
                14.5. Je-li nebo stane-li se některé ustanovení těchto VOP
                neplatným nebo nevymahatelným, nedotýká se to platnosti
                ostatních ustanovení.
              </p>
              <p>
                14.6. Tyto VOP nabývají účinnosti dne 10. února 2026.
              </p>
            </div>
          </div>
        </div>
