...
const TASKS = [
  ...
  { name: "prospecting", label: "🏭 Prospecting ARES", desc: "Načti nové firmy z ARES" },
  { name: "scanning", label: "🌐 Skenování firem", desc: "Skenuj nové firmy z fronty" },
  { name: "emailing", label: "📧 Email kampaň", desc: "Pošli emaily naskenovaným" },
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-sm font-mono">
                ...
                <div className="flex gap-4"><span className="text-fuchsia-400 w-16">04:00</span><span className="text-gray-300">ARES prospecting — nové firmy</span></div>
                <div className="flex gap-4"><span className="text-fuchsia-400 w-16">05:00</span><span className="text-gray-300">Skenování firem z fronty</span></div>
                <div className="flex gap-4"><span className="text-fuchsia-400 w-16">08:00</span><span className="text-gray-300">Email kampaň — naskenované firmy</span></div>
