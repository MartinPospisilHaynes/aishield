...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: "/blog/ai-act-a-e-shopy-v-cr.png", width: 1200, height: 630 }],
    },
    keywords: [
        "AI Act e-shopy",
        "AI Act chatbot povinnost",
        "e-shop AI compliance",
        "AI Act Česko e-commerce",
        "transparenční stránka e-shop",
        "AI Act srpen 2026",
    ],
};
...
const jsonLd = {
    ...
    "@type": "BlogPosting",
    headline: "AI Act a české e-shopy: co musíte splnit do srpna 2026",
    description: "Praktický průvodce pro majitele českých e-shopů. Chatboty, doporučování produktů, remarketing — co musíte splnit dle AI Actu.",
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": "https://aishield.cz/blog/ai-act-a-e-shopy-v-cr" },
    inLanguage: "cs",
    image: "https://aishield.cz/blog/ai-act-a-e-shopy-v-cr.png",
    keywords: "AI Act e-shopy, AI Act chatbot, e-shop AI compliance, transparenční stránka",
};
