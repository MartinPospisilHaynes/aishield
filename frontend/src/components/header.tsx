...
export default function Header() {
    ...
    // Sleduj scroll pro shadow efekt
    useEffect(() => {
    ...
    return (
        <header className={`sticky top-0 z-50 border-b border-white/[0.06] bg-dark-900/80 backdrop-blur-xl transition-shadow duration-300 ${scrolled ? "shadow-lg shadow-black/30" : ""}`}>
