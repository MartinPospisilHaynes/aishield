            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg bg-fuchsia-600/90 px-3 py-1.5 text-sm font-semibold text-white hover:bg-fuchsia-500 transition shadow-sm shadow-fuchsia-500/20"
                    >
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <a href="/registrace" className="btn-secondary text-sm px-4 py-2">
                                Registrovat se
                            </a>
                            ...
                            <div className="space-y-2">
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <a
                                        href="/registrace"
                                        onClick={() => setMobileOpen(false)}
                                        className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-2xl bg-gradient-to-r from-fuchsia-600/20 to-purple-600/20 border border-fuchsia-500/30 text-fuchsia-400 font-semibold text-sm hover:from-fuchsia-600/30 hover:to-purple-600/30 transition-all active:scale-[0.98]"
                                    >
                                ...
                                <a
                                    href="/scan"
                                    onClick={() => setMobileOpen(false)}
                                    className="flex items-center justify-center gap-2 w-full px-4 py-3.5 rounded-2xl bg-gradient-to-r from-fuchsia-600 to-purple-600 text-white font-semibold text-sm hover:from-fuchsia-500 hover:to-purple-500 transition-all active:scale-[0.98] shadow-lg shadow-fuchsia-500/20"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" /></svg> Skenovat web ZDARMA
                                </a>
                            </div>
                        )}
                    </div>
