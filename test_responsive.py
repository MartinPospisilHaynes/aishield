            ...
            for pg in PAGES:
                ...
                try:
                    ...
                    overflow = await page.evaluate("""() => {
                        ...
                        // Check actual scrollbar overflow
                        ...
                        // Helper: is element visually clipped by overflow-hidden ancestor?
                        function isClipped(el) {
                            ...
                            const bodyOx = window.getComputedStyle(body).overflowX;
                            return bodyOx === 'hidden' || bodyOx === 'clip';
                        }
                        
                        // Check elements but skip visually-clipped ones
