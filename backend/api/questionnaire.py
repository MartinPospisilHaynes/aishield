...
def _get_recommendation(question_key: str, risk: str, tool_name: str, details: Optional[dict]) -> str:
    ...
    recs = {
        ...
        # Lidský dohled a governance
        "has_oversight_person": "POVINNOST čl. 14 AI Act! Určete odpovědnou osobu za dohled nad AI systémy. Bez jasně přiřazené zodpovědnosti nelze zajistit lidský dohled vyžadovaný nařízením.",
        "can_override_ai": "POVINNOST čl. 14 odst. 4 písm. d) AI Act! Zaměstnanci musí mít možnost rozhodnutí AI systému nepoužít, přepsat nebo zrušit. Nastavte eskalační procesy a školte zaměstnance.",
        "modifies_ai_purpose": "Podstatná úprava AI systému vás dle čl. 25 AI Act činí poskytovatelem — přebíráte povinnosti původního výrobce včetně posouzení shody. Konzultujte právní dopady.",
        "has_incident_plan": "POVINNOST čl. 73 AI Act! Připravte plán řízení AI incidentů — postup při chybě AI, eskalační řetězec, hlášení závažných incidentů dozorové autoritě. AIshield vám dodá šablonu.",
        # Logování a monitoring
        "ai_decision_logging": "Čl. 26 odst. 1 písm. f) AI Act vyžaduje uchovávání automaticky generovaných protokolů minimálně 6 měsíců. Zaveďte logování rozhodnutí AI systémů a stanovte dobu uchovávání.",
        "monitors_ai_outputs": "Čl. 9 AI Act vyžaduje průběžné řízení rizik včetně monitoringu výstupů AI. Zaveďte pravidelnou kontrolu kvality — definujte KPI, metriky a měsíční checklist.",
        "tracks_ai_changes": "Příloha IV bod 6 AI Act vyžaduje dokumentaci všech změn AI systémů. Zaveďte evidenci změn — stačí tabulka s datem, názvem systému a popisem změny.",
