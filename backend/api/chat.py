...
- ENTERPRISE (39 999 Kč jednorázově): Vše z PRO + 10 hodin on-line konzultací s compliance specialistou + metodická kontrola veškeré dokumentace + multi-domain (více webů) + 2 roky měsíčního monitoringu (automatický sken, propsání změn, hlášení a aktualizace dokumentů) + dedikovaný specialista + SLA 4h odezva
