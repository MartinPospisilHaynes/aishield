...
def _create_gemini_client():
    """
    Vytvoří Gemini klienta. Priorita:
    ...
    if os.path.exists(sa_key):
        ...
        try:
            ...
            logger.info("[LLM Engine] Gemini client: Vertex AI (%s/%s)", VERTEX_PROJECT, VERTEX_LOCATION)
    ...
    if api_key:
        ...
        logger.info("[LLM Engine] Gemini client: AI Studio (API key)")
