...
═══ CHYBĚJÍCÍ DATA — FALLBACK PRAVIDLO ═══

Pokud konkrétní údaj v {company_context} chybí (např. jméno systému, typ dat, číslo zaměstnanců):
- NIKDY si data nevymýšlej a nehalucinuj.
- Označ chybějící údaj jako: [K DOPLNĚNÍ KLIENTEM: stručný popis co doplnit]
- Příklad: „Odpovědná osoba za AI: [K DOPLNĚNÍ KLIENTEM: jméno a role zaměstnance]"
- Příklady z praxe tvoř VÝHRADNĚ ze systémů a procesů uvedených v kontextu.
  Pokud pro dané doporučení nemáš v kontextu dostatek dat, uveď obecný odvětvový
  příklad a jasně ho označ jako hypotetický.
- Lepší je přiznat mezeru než vymyslet nepravdivý údaj.
...
<h2>3. Nalezené AI systémy — detailní přehled</h2>
- <table> se VŠEMI nalezenými systémy (ze skenu i dotazníku)
- Sloupce: Název systému | Zdroj detekce | Riziková kategorie | Relevantní článek AI Act | Stav
- Pod tabulkou: vysvětlení každé rizikové kategorie
- Specifické riziko pro KAŽDÝ systém — proč má danou kategorii
...
<h2>4. Transparenční stránka</h2>
- .info box: „HTML kód transparenční stránky pro váš web jste obdrželi v Compliance Kitu.
  Stránka obsahuje kompletní přehled AI systémů a je připravena k nasazení."
- Jak stránku nasadit: předat IT, umístit na URL, prolinkovat z patičky webu
- Kde na webu umístit odkaz na transparenční stránku
...
- Kontaktní email z kontextu firmy (nebo [K DOPLNĚNÍ KLIENTEM])
...
<ul>
<li>Modul 1 — Co je umělá inteligence (30 min)</li>
<li>Modul 2 — EU AI Act v kostce (45 min)</li>
<li>Modul 3 — AI v naší firmě (30 min)</li>
<li>Modul 4 — Bezpečné používání AI v praxi (30 min)</li>
<li>Modul 5 — Naše povinnosti (15 min)</li>
<li>Modul 6 — Shrnutí a další kroky (15 min)</li>
</ul>

<h2>Slide 3: Co je umělá inteligence</h2>
<ul>
<li>Definice AI — co to je a co to není</li>
<li>Typy AI: generativní AI, prediktivní modely, expertní systémy</li>
<li>Příklady AI v každodenním životě</li>
<li>AI vs. automatizace — jaký je rozdíl?</li>
<li>Konkrétní příklad z odvětví firmy: [PERSONALIZUJ]</li>
</ul>

<h2>Slide 4: EU AI Act v kostce</h2>
<ul>
<li>Proč EU reguluje AI — ochrana základních práv</li>
<li>Nařízení (EU) 2024/1689 — plná účinnost 2. 8. 2026</li>
<li>4 kategorie rizik: nepřijatelné → vysoké → omezené → minimální</li>
<li>Zakázané praktiky (čl. 5) — od 2. 2. 2025</li>
<li>Povinnost AI gramotnosti (čl. 4) — od 2. 2. 2025</li>
<li>Pokuty: až 35 mil. EUR nebo 7 % obratu</li>
</ul>

<h2>Slide 5: 4 kategorie rizik AI Act</h2>
<ul>
...
<li>MINIMÁLNÍ RIZIKO — bez povinností (spam filtry, doporučení)</li>
</ul>

<h2>Slide 6: Zakázané AI praktiky (čl. 5)</h2>
<ul>
<li>Social scoring — hodnocení lidí podle chování</li>
<li>Manipulativní AI — podprahové ovlivňování</li>
...
<li>Scraping obličejů z internetu</li>
</ul>

<h2>Slide 7: AI v naší firmě [PERSONALIZUJ]</h2>
<ul>
<li>Používáme [N] AI nástrojů: [SEZNAM z kontextu]</li>
<li>Odpovědná osoba za AI: [jméno z kontextu nebo „přiřadit"]</li>
<li>Registr AI systémů — interní dokument (součást Compliance Kitu)</li>
<li>Interní AI politika — co smíme a co ne</li>
<li>Pravidla pro vkládání dat do AI nástrojů</li>
</ul>

<h2>Slide 8: Přehled rizik našich AI systémů [PERSONALIZUJ]</h2>
- Pro KAŽDÝ AI systém firmy uveď název + rizikovou kategorii
- Formát: tabulkový přehled jako odrážky
- Příklad: „ChatGPT (omezené riziko — čl. 50)", „HR screening tool (vysoké riziko)"

<h2>Slide 9: Bezpečné používání AI v praxi</h2>
<ul>
<li>ChatGPT / Claude / Copilot — jak správně a bezpečně používat</li>
<li>Co do AI NIKDY nevkládat (osobní údaje, hesla, smlouvy, interní data)</li>
<li>Ověřování výstupů AI — „trust but verify" (AI halucinuje)</li>
<li>Označování AI-generovaného obsahu</li>
<li>Hlášení incidentů — [PERSONALIZUJ dle kontextu]</li>
</ul>

<h2>Slide 10: AI a ochrana osobních údajů (GDPR)</h2>
<ul>
<li>AI zpracovává osobní údaje — platí GDPR</li>
...
<li>Minimalizace dat — do AI jen nezbytné minimum</li>
<li>[PERSONALIZUJ — zpracovává firma osobní údaje přes AI?]</li>
</ul>

<h2>Slide 11: Naše konkrétní povinnosti [PERSONALIZUJ]</h2>
- Pro KAŽDOU povinnost uveď stav: ✅ splněno / ⚠ chybí
- Zakázané praktiky, Incident Response Plán, Registr AI, Smlouvy s dodavateli,
  Školení AI gramotnosti — vyhodnoť dle kontextu firmy

<h2>Slide 12: Shrnutí a další kroky</h2>
<ul>
<li>AI gramotnost je zákonná povinnost od 2. 2. 2025</li>
<li>Opakujte školení 1× ročně jako refresher</li>
<li>Dodržujte interní AI politiku</li>
<li>Při nejistotě se obraťte na odpovědnou osobu za AI</li>
<li>[PERSONALIZUJ — konkrétní next steps pro firmu]</li>
</ul>

<h2>Slide 13: Právní doložka</h2>
...
<p>Soulad s AI Act dle stavu k [datu].</p>
...
═══ TEXT NESMÍ OBSAHOVAT ═══
- Emoji (kromě ✅ a ⚠ pro stav povinností)
- Zmínky o testech, kvízech nebo certifikacích — AIshield je neposkytuje
...
async def generate_draft(company_context: str, doc_key: str) -> Tuple[str, dict]:
    ...
    if enhanced_prompt != SYSTEM_PROMPT_M1:
        logger.info(f"[M1 Generator] M5 pravidla aktivní (+{len(enhanced_prompt) - len(SYSTEM_PROMPT_M1)} znaků)")
